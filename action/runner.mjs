...
const actionDirectory = path.dirname(path.dirname(fileURLToPath(import.meta.url)));
...
const reportDirectory = path.join(process.env.RUNNER_TEMP ?? process.cwd(), 'repo-doctor');
